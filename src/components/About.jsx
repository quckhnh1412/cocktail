    ...
    <div id='about'>
        <div className='mb-16 md:px-0 px-5'>
            <div className='content'>
                ...
                <div className='sub-content'>
                    ...
                    <div>
                        <p className='md:text-text-3xl text-xl font-bold'>
                            <span>4.5</span>/5
                        </p>
        ...
        <div className='top-grid'>  
            <div className='md:col-span-3'>
                <div className='noisy'/>
                <img src="/images/abt1.png" alt="about" />
            </div>
            <div className='md:col-span-6'>
                <div className='noisy'/>
                <img src="/images/abt2.png" alt="about" />
            </div>
            <div className='md:col-span-3'>
                <div className='noisy'/>
                <img src="/images/abt5.png" alt="about" />
            </div>
        </div>
        <div className='bottom-grid'>
           <div className='md:col-span-8'>
                <div className='noisy'/>
                <img src="/images/abt3.png" alt="about" />
            </div>
            <div className='md:col-span-4'>
                <div className='noisy'/>
                <img src="/images/abt4.png" alt="about" />
            </div>
        </div>
    </div>
  )
